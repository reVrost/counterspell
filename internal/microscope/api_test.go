...
func createTestEcho(database *sql.DB, authToken string) *echo.Echo {
	...
	// Add auth middleware
	api := e.Group("/microscope/api", middleware.KeyAuth(func(key string, c echo.Context) (bool, error) {
...
func TestAPIHandler_QueryLogs(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/microscope/api/logs?limit=10", nil)
...
func TestAPIHandler_QueryLogsWithFilters(t *testing.T) {
	...
	// Test level filter
	req := httptest.NewRequest(http.MethodGet, "/microscope/api/logs?level=error", nil)
	req.Header.Set("Authorization", "Bearer test-token")
	rec := httptest.NewRecorder()
...
func TestAPIHandler_QueryTraces(t *testing.T) {
	...
	// Test successful request
	req := httptest.NewRequest(http.MethodGet, "/microscope/api/traces?limit=10", nil)
	req.Header.Set("Authorization", "Bearer test-token")
	rec := httptest.NewRecorder()
...
func TestAPIHandler_QueryTracesWithErrorFilter(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/microscope/api/traces?has_error=true", nil)
	req.Header.Set("Authorization", "Bearer test-token")
	rec := httptest.NewRecorder()
...
func TestAPIHandler_GetTraceDetails(t *testing.T) {
	...
	// Test successful request
	req := httptest.NewRequest(http.MethodGet, "/microscope/api/traces/trace123", nil)
	req.Header.Set("Authorization", "Bearer test-token")
	rec := httptest.NewRecorder()
...
func TestAPIHandler_GetTraceDetailsNotFound(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/microscope/api/traces/nonexistent", nil)
	req.Header.Set("Authorization", "Bearer test-token")
	rec := httptest.NewRecorder()
...
func TestAPIHandler_QueryLogsTextSearch(t *testing.T) {
	...
	// Test text search
	req := httptest.NewRequest(http.MethodGet, "/microscope/api/logs?q=error", nil)
	req.Header.Set("Authorization", "Bearer test-token")
	rec := httptest.NewRecorder()
...
func TestAPIHandler_QueryLogsPagination(t *testing.T) {
	...
	// Test pagination
	req := httptest.NewRequest(http.MethodGet, "/microscope/api/logs?limit=2&offset=1", nil)
	req.Header.Set("Authorization", "Bearer test-token")
	rec := httptest.NewRecorder()
