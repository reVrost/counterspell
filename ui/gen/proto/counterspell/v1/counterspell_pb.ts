...
/**
 * @generated from message counterspell.v1.ListTracesRequest
 */
export type ListTracesRequest = Message<"counterspell.v1.ListTracesRequest"> & {
  /**
   * @generated from field: counterspell.v1.Pagination pagination = 1;
   */
  pagination?: Pagination;
...
/**
 * Describes the message counterspell.v1.ListTracesRequest.
...
/**
 * @generated from message counterspell.v1.ListTracesResponse
 */
export type ListTracesResponse = Message<"counterspell.v1.ListTracesResponse"> & {
  /**
...
/**
 * Describes the message counterspell.v1.ListTracesResponse.
...
export const Service: GenService<{
  ...
  /**
   * @generated from rpc counterspell.v1.Service.ListTraces
   */
  listTraces: {
    methodKind: "unary";
