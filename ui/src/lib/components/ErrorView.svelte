...
>
    ...
    >
        {#if mounted}
            <div
                in:scale={{ duration: 800, start: 0.95, delay: 100 }}
            ...
            >
                ...
                <div class="relative z-10">
                    ...
                    >
                        ...
                        >
                            <i
                                class="fas fa-exclamation-triangle text-destructive text-2xl -rotate-12"
                            ></i>
                        </div>
                    </div>
                </div>
            ...
            >
                ...
                <p
                    class="text-base text-muted-foreground/80 leading-relaxed font-medium"
                >
                    {description}
                </p>
            </div>
    ...
    >
        ...
        <div class="pt-8 flex justify-center opacity-30 select-none">
            <span class="text-[10px] uppercase font-black tracking-[0.3em]"
                >Counterspell</span
            >
        </div>
    </div>
