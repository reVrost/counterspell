...
require (
	...
	github.com/revrost/go-openrouter v0.2.4 // indirect
...
// Uncomment and update when Echo v5 is available:
// replace github.com/labstack/echo/v5 => github.com/labstack/echo/v5 v5.0.0-alpha
